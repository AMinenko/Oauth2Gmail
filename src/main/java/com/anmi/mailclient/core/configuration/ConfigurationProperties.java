package com.anmi.mailclient.core.configuration;

public class ConfigurationProperties {
    public static final String OAUTH_CODE_URL = "oauth.code.url".intern();
    public static final String OAUTH_TOKEN_URL = "oauth.token.url".intern();
